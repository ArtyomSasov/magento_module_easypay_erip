<?php
class EasyPay_Erip_Model_Redirect extends Mage_Payment_Model_Method_Abstract
{
	protected $_code = 'erip_redirect';
	...
	{
		  return Mage::getUrl('erip/payment/redirect', array('_secure' => true));
	}
	...
	public function getRedirectFormFields()
	{
		...
		$result['EP_URL_Type'] = 'get';
		$result['EP_Encoding'] = 'utf-8';
        $result['EP_PayType'] = 'PT_ERIP';
